                ...
                if 'probe' in cfg['prune_method'] and ('down_proj' in cfg['cust_tgt_modules'] or 'up_proj' in cfg['cust_tgt_modules'] or 'gate_proj' in cfg['cust_tgt_modules']):
                    ...
                    if 'fillpbmetric' in cfg['prune_method']:
                        ...
                        if 'runningmean' in cfg['prune_method']:
                            ...
                            if 'fillpbmetricoriginal':
                                self.down_proj.update_global_metric_score_distribution_ema(probe_out[..., prune_out_dim_indices], prune_out_dim_indices)
                            elif 'fillpbmetriccombine':
                                self.down_proj.update_global_metric_score_distribution_ema(comined_probe_out[..., prune_out_dim_indices], prune_out_dim_indices)
