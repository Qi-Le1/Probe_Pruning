...
def main():
    ...
    if file == 'test_model':
        ...
        if 'clm' in data:
            ...
            #                  ['ppwandasp'], ['probe-default'], ['asyncintra', 'sync'], ['c4-2000'], ['0.5+0.05-0.5+0.05-0.5+0.05-0.5+0.05-0.5+0.05-seqrank+bszrank'],
            #                 ['default']]]
            # CIFAR10_controls_9 = make_controls(script_name, init_seeds, device, resume_mode, control_name)
            # controls.extend(CIFAR10_controls_9)
            ...
            #             ['default']]]
            # CIFAR10_controls_9 = make_controls(script_name, init_seeds, device, resume_mode, control_name)
            # controls.extend(CIFAR10_controls_9)'0.05-0.05-0.05-0.05-0.05-seqrank', '0.5+0.05-0.5+0.05-0.5+0.05-0.5+0.05-0.5+0.05-seqrank+bszrank'

            # control_name = [[['wikitext-2v1'], ['llama-2-7b'], ['clm'], ['20'], ['1024'], ['0.4'], 
            #                 ['ppwandasp'], ['probe-calib-respick-ema', 'probe-calib-respick-ema-ruleranklast', 'probe-calib-respick-ema-deleteoutlier'], ['asyncintra'], ['c4-2000'], ['0.5-0.5-0.5-0.5-0.5-seqrank'],
            #             ['default']]]
            # CIFAR10_controls_9 = make_controls(script_name, init_seeds, device, resume_mode, control_name)
            # controls.extend(CIFAR10_controls_9)
            ...
            # control_name = [[['wikitext-2v1'], ['llama-2-13b', 'opt-13b'], ['clm'], ['20'], ['1024'], ['0.2', '0.4'], 
            #                 ['ppwandasp'], ['probe-calib-respick-ema'], ['asyncintra'], ['c4-2000'], ['0.5+0.05-0.5+0.05-0.5+0.05-0.5+0.05-0.5+0.05-seqrank+bszrank'],
            #             ['default']]]
            # CIFAR10_controls_9 = make_controls(script_name, init_seeds, device, resume_mode, control_name)
            # controls.extend(CIFAR10_controls_9)
            ...
            # control_name = [[['wikitext-2v1'], ['llama-2-7b'], ['clm'], ['20'], ['1024'], ['0.2'], 
            #                  ['flap'], ['flap-default'], ['asyncinter'], ['c4-2000'], ['None'],
            #                 ['default']]]
            # CIFAR10_controls_9 = make_controls(script_name, init_seeds, device, resume_mode, control_name)
            # controls.extend(CIFAR10_controls_9)
            ...
            control_name = [[['wikitext-2v1'], ['llama-2-7b'], ['clm'], ['20'], ['1024'], ['0.4'], 
                             ['flap'], ['probe-flap-default'], ['sync'], ['None'], ['1-1-1-1-1-seqrank'],
                            ['default']]]
            CIFAR10_controls_9 = make_controls(script_name, init_seeds, device, resume_mode, control_name)
            controls.extend(CIFAR10_controls_9)

            control_name = [[['wikitext-2v1'], ['llama-2-7b'], ['clm'], ['20'], ['1024'], ['0.4'], 
                                ['flap'], ['probe-flap-flapratio-bias-respick-ema-calib'], ['sync'], ['c4-2000'], ['0.5+0.05-0.5+0.05-0.5+0.05-0.5+0.05-0.5+0.05-seqrank+bszrank'],
                            ['default']]]
            CIFAR10_controls_9 = make_controls(script_name, init_seeds, device, resume_mode, control_name)
            controls.extend(CIFAR10_controls_9)
            ...
            # 923/2024
            # control_name = [[['boolq', 'piqa', 'hellaswag', 'winogrande', 'arc-c', 'arc-e', 'obqa'], ['llama-3-8b'], ['csr'], ['20'], ['512'], ['0.2', '0.4'], 
            #                 ['ppwandasp'], ['probe-default'], ['asyncintra'], ['c4-2000'], ['0.5+0.05-0.5+0.05-0.5+0.05-0.5+0.05-0.5+0.05-seqrank+bszrank'],
            #             ['gate-proj+up-proj+down-proj']]]
            # CIFAR10_controls_9 = make_controls(script_name, init_seeds, device, resume_mode, control_name)
            # controls.extend(CIFAR10_controls_9)

            # control_name = [[['boolq', 'piqa', 'hellaswag', 'winogrande', 'arc-c', 'arc-e', 'obqa'], ['llama-2-13b'], ['csr'], ['20'], ['512'], ['0.2', '0.4'], 
            #                 ['ppwandasp'], ['probe-default'], ['asyncintra'], ['c4-2000'], ['0.5+0.05-0.5+0.05-0.5+0.05-0.5+0.05-0.5+0.05-seqrank+bszrank'],
            #             ['default']]]
            # CIFAR10_controls_9 = make_controls(script_name, init_seeds, device, resume_mode, control_name)
            # controls.extend(CIFAR10_controls_9)
    ...
    # model, seq, metric, calib, target module important
        ...
        if 'clm' in data:
            ...
            control_name = [[['wikitext-2v1'], ['llama-2-7b'], ['clm'], ['20'], ['512', '1024', '2048'], ['0'], 
                             ['None'], ['dense'], ['None'], ['None'], ['None'],        
                            ['None']]]
            CIFAR10_controls_9 = make_controls(script_name, init_seeds, device, resume_mode, control_name)
            controls.extend(CIFAR10_controls_9)
            # control_name = [[['wikitext-2v1'], ['opt-13b'], ['clm'], ['20'], ['1024'], ['0'], 
            #                  ['None'], ['dense'], ['None'], ['None'], ['None'],        
            #                 ['None']]]
            # CIFAR10_controls_9 = make_controls(script_name, init_seeds, device, resume_mode, control_name)
            # controls.extend(CIFAR10_controls_9)
