...
class LayerInfo:
    ...
    def calculate_macs(self) -> None:
        ...
        # print('\n!!calculate_macs', self.class_name, self.output_size, self.module, flush=True)
        for name, param in self.module.named_parameters():
            cur_params, name = self.get_param_count(self.module, name, param)
            ...
            # print('calculate_macs', name, cur_params, self.macs)
