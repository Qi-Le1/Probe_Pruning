...
python3 large_scale_commands_creation_msi.py --pbs_prefix msiout --file classifier_fl --code_folder Efficient_representation_inference --res_folder msiout --run test --device cuda --num_gpus 1 --round 1 --world_size 1 --num_experiments 1 --experiment_step 1 --init_seed 0 --resume_mode 0 --log_interval 0.25 --data CIFAR10
